...
$('#aggregation_type').focus(function(){
    ...
    if (agg_type == 1) {
       ...
       var warning_text = "Do you want to switch to show all data? This may include data from several years ago. Please note that the 2016 Index will only consider current data.";
    } else {
